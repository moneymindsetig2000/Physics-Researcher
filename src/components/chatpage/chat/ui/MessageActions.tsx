      ...
      {sender === 'ai' && (
        <>
          <button
            ...
            title="Like"
          >
            <svg viewBox="0 0 24 24" width="14" height="14" fill={liked === true ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14zM7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" />
            </svg>
          </button>
          <button
            className={`action-btn ${liked === false ? 'action-btn-active' : ''}`}
            onClick={() => setLiked(liked === false ? null : false)}
            title="Dislike"
          >
            <svg viewBox="0 0 24 24" width="14" height="14" fill={liked === false ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
